...
Tags: block, posts, blog posts, display blog posts, embed custom posts, Gutenberg posts
...
Transform Your Posts or Custom Posts Display with Advanced Layouts. Create Stunning Grids, Masonry, Sliders, or Tickers for Posts. Upgrade Your Posts Showcase Now!

== Description ==

Transform Your **Posts** or **Custom Posts** displays with advanced layouts in the Gutenberg block editor. Create Stunning **Grids, Masonry, Sliders, or Tickers** for Posts. Upgrade Your Posts Showcase Now!
...
- **Sub Layouts:** Combine the layout with these sub-layouts: Default, Title Meta, Left Image, Right Image, Overlay Content, Overlay Content Hover, Overlay Box.
