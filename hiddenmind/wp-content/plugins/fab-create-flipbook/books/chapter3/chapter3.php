...
$properties = getProperties_chapter3();                             // CHANGE THIS - getProperties_XXX();
$shortCodeString = $properties['short_code_string'];


// Add a shortcode to insert the flipbook in posts
    function shortcode_chapter3($atts) {                            // CHANGE THIS - shortcode_XXX($atts)

        $arrayImagePaths = getArrayImagePath_chapter3();            // CHANGE THIS - getArrayImagePath_XXX(); 
        $properties = getProperties_chapter3();                     // CHANGE THIS - getProperties_XXX();
    ...
    add_shortcode($shortCodeString, 'shortcode_chapter3');      // CHANGE THIS - add_shortcode($shortCodeString, 'shortcode_XXX');



    function getArrayImagePath_chapter3(){                      // CHANGE THIS - function getArrayImagePath_XXX(){ 
    ...
    function getProperties_chapter3(){                      // CHANGE THIS - function getProperties_XXX(){ 
