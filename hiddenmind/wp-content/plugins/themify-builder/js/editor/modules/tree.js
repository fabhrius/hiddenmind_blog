        ...
        getGridCss(){
            const builderCss=doc.tfId('themify_concate-css') || doc.tfId('themify-builder-style-css'),
                ...
                for (let i =rules.length-1; i>-1;--i) {
                    ...
                    if(selText){
                        if ( selText.includes('.row_inner')  && selText.includes('.subrow_inner') && rules[i].cssText.includes('--col') && rules[i].cssText.includes('grid-template-areas')) {
                        ...
                        else if(selText.includes('.module_column') && (rules[i].cssText.includes('grid-area') || rules[i].cssText.includes('grid-template-columns'))){
