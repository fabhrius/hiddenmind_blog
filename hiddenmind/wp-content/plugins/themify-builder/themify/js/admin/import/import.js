                    ...
                    _getBuilderImages=fields=>{
                        ...
                        addImage=url=>{
                            if(url){
                                ...
                                if(['jpg', 'jpeg', 'tiff', 'png', 'gif', 'bmp', 'svg','webp','apng'].includes(parts[parts.length - 1])){
                                    images.add(url);
                                }
                            }
                        },
                                    ...
                                    if(builder){
                                        ...
                                        for(let [url,res] of allImages){
                                            if(res!==false && res.src){
                                                if(builder.includes(url)){
                                                    builder=builder.replaceAll(url,res.src);
                                                }
                                                if(posts[i].post_content && posts[i].post_content.includes(url)){
