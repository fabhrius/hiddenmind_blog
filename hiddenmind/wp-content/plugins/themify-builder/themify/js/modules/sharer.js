...
((Themify, doc, win)=>{
    ...
    Themify.on('tf_sharer_init', (type, url, title)=>{
        ...
        const width = 550,
            height = 300,
            leftPosition = (Themify.w/ 2) - ((width / 2) + 10),
            topPosition = (Themify.h / 2) - ((height / 2) + 50),
        ...
        if ('facebook' === type) {
            ...
            title=title || doc.tfTag('title')[0].textContent;
            url = 'mailto:?subject=' + (title || themify_vars.emailSub) + '&body=' + url;
        }
