    ...
    ThemifyStyles = {
        ...
        fields: {
            ...
            position_box(id, type, args, data, elementId, allData) {
                ...
                if (prop === 'background-position' && (data[args.origId] === und || data[args.origId] === '') && !(data['__dc__'] && data['__dc__'][args.origId] !== und && data['__dc__'][args.origId] !== '')) {
                    return false;
                }
                if (v.includes('-')) {
                    v = v.replace('-', ' ');
            ...
            filters(id, type, args, data, elementId, allData) {
                ...
                selector = '';
                for (let k in ranges) {
                    let v = this.getStyleVal( args.id + '_' + k, allData);
                    if (v!==und) {
