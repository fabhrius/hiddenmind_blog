	...
	public function get_options() {
		return array(
			...
			array(
				...
				'options' => array(
					array('img' => 'solid', 'value' => 'solid', 'label' => 'solid'),
					array('img' => 'dotted', 'value' => 'dotted', 'label' => 'dotted'),
					array('img' => 'dashed', 'value' => 'dashed', 'label' => 'dashed'),
					array('img' => 'double', 'value' => 'double', 'label' => 'double')
				)
			),
			array(
				'id' => 'stroke_w_divider',
			...
			array(
				...
				'options' => array(
					array('value' => 'fullwidth', 'name' => 'fw'),
					array('value' => 'custom', 'name' => 'cus')
				),
				'option_js' => true
			),
			array(
