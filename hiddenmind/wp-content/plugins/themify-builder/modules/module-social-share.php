...
class TB_Social_Share_Module extends Themify_Builder_Component_Module {
	...
	public function get_options() {
		...
		return array(
			...
			array(
				...
				'mode' => 'sprite',
				'options' => array(
					array('img' => 'horizontal_button', 'value' => 'h', 'label' => 'hrztal'),
					array('img' => 'vertical_button', 'value' => 'v', 'label' => 'vertical'),
				)
			),
			array(
				'id' => 'title',
	...
	protected function _visual_template() {
		...
		?>
		<#	const nets = data.networks  ? data.networks.split('|') : [],
				info=data.networks.length===0?{}:{
