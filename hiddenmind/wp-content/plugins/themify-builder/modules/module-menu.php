...
class TB_Menu_Module extends Themify_Builder_Component_Module {
	...
	public function get_options() {
		return array(
			...
			array(
				'id' => 'mega',
				'label' => __('Mega Menu', 'themify'),
				'type' => 'toggle_switch',
				'options' => array(
					'on' => array('name' => 'y', 'value' => 'en'),
					'off' => array('name' => '', 'value' => 'dis')
				),
				'help' => sprintf( __( 'Configure mega menu at <a href="%s" target="_blank">Appearance > Menus</a> (<a href="%s" target="_blank">read more</a>)', 'themify' ), admin_url( 'nav-menus.php' ), 'https://themify.me/docs/builder#mega-menu' )
			),
			array(
		...
		$menu_dropdown_links = array(
			...
			self::get_expand('Container', array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
							self::get_color('.module li > .sub-menu', 'd_l_ctn_b_c', 'bg_c', 'background-color')
						)
					),
					'h' => array(
						'options' => array(
							self::get_color('.module li > .sub-menu:hover', 'd_l_ctn_b_c_h', __('Background Hover', 'themify'), 'background-color')
						)
					)
				))
			)),
			...
			self::get_expand('bg', array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
							self::get_color('.module li > .sub-menu a', 'dropdown_links_background_color', 'bg_c', 'background-color')
						)
					),
					'h' => array(
						'options' => array(
							self::get_color('.module li > .sub-menu a:hover', 'dropdown_links_hover_background_color', __('Background Hover', 'themify'), 'background-color')
						)
					)
				))
			)),
			...
			self::get_expand('f', array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
							self::get_font_family('.module .nav li > .sub-menu a', 'font_family_menu_dropdown_links'),
							self::get_color('.module .nav li > .sub-menu a', 'dropdown_links_color'),
							self::get_font_size('.module .nav li > .sub-menu a', 'font_size_menu_dropdown_links'),
							self::get_line_height('.module .nav li > .sub-menu a', 'l_h_m_d_l'),
							self::get_letter_spacing('.module .nav li > .sub-menu a', 'l_s_m_d_l'),
							self::get_text_align('.module .nav li > .sub-menu a', 't_a_m_d_l'),
							self::get_text_transform('.module .nav li > .sub-menu a', 't_t_m_d_l'),
							self::get_font_style('.module .nav li > .sub-menu a', 'f_d_l', 'f_d_b'),
							self::get_text_decoration('.module .nav li > .sub-menu a', 't_d_m_d_l'),
							self::get_text_shadow('.module .nav li > .sub-menu a', 't_sh_l'),
						)
					),
					'h' => array(
						'options' => array(
							self::get_font_family('.module .nav li > .sub-menu a', 'f_f_m_d_l', 'h'),
							self::get_color('.module .nav li > .sub-menu a:hover', 'dropdown_links_hover_color', __('Color Hover', 'themify')),
							self::get_font_size('.module .nav li > .sub-menu a', 'f_s_m_d_l', '', null, null, 'h'),
							self::get_font_style('.module .nav li > .sub-menu a', 'f_d_l', 'f_d_b', 'h'),
							self::get_text_decoration('.module .nav li > .sub-menu a', 't_d_m_d_l', 'h'),
							self::get_text_shadow('.module .nav li > .sub-menu a', 't_sh_l', 'h'),
						)
					)
				))
			)),
			...
			self::get_expand('p', array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
							self::get_padding('.module li > .sub-menu a', 'd_l_p')
						)
					),
					'h' => array(
						'options' => array(
							self::get_padding('.module li > .sub-menu a', 'd_l_p_h', 'h')
						)
					)
				))
			)),
			...
			self::get_expand('m', array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
							self::get_margin('.module li > u.sub-menu a', 'd_l_m')
						)
					),
					'h' => array(
						'options' => array(
							self::get_margin('.module li > .sub-menu a', 'd_l_m_h', 'h')
						)
					)
				))
			)),
			...
			self::get_expand('b', array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
							self::get_border('.module li > .sub-menu a', 'd_l_b')
						)
					),
					'h' => array(
						'options' => array(
							self::get_border('.module li > .sub-menu a', 'd_l_b_h', 'h')
						)
					)
				))
			))
