		...
		return array(
			...
			array(
				...
				'options' => array(
					array(
						'id' => 'autoplay',
						'label' => __('Auto Switch Tab', 'themify'),
						'type' => 'toggle_switch',
						'options' => array(
						...
						'binding' => array(
							'checked' => array(
								'show' => [ 'autoplay_timer', 'autoplay_c' ]
							),
							'not_checked' => array(
								'hide' => [ 'autoplay_timer', 'autoplay_c' ]
							)
						)
					),
					array(
						'id' => 'autoplay_timer',
						'type' => 'number',
						'label' => __('Timer', 'themify'),
						'after' => __('Second(s)', 'themify'),
					),
					array(
						'id' => 'autoplay_c',
						'label' => __('Stop After Tab Click', 'themify'),
						'type' => 'toggle_switch',
						'options' => array(
							'on' => array('name' => 'y', 'value' => 'en'),
							'off' => array('name' => '', 'value' => 'dis')
