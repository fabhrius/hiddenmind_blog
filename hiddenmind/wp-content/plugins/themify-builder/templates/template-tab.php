...
<div <?php echo self::get_element_attributes(self::sticky_element_props($container_props,$fields_args)); ?>>
    ...
    <div class="builder-tabs-wrap tf_rel">
		<div class="tab-nav-current-active tf_hide">
			...
			<span class="tb_tab_title"<?php self::add_inline_edit_fields('title_tab',true,false,'tab_content_tab',0)?>><?php echo isset( $fields_args['tab_content_tab'][0]['title_tab'] ) ? $fields_args['tab_content_tab'][0]['title_tab'] : ''; ?></span>
		</div>
