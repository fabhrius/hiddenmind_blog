...
= 7.0.4 (2023.08.23) =
* New: Builder: Mega menu feature on Menu module
* New: Builder: Tab: Add auto switch tab feature
* New: Builder: Add padding drag overlay manual input
* Fix: Builder: TOC Module: Fixed the list bullets rendering of different types
* Fix: Builder: Fixed the Link Block image right alignment styling
* Fix: Builder: The image/icon added on the fancy-Heading module does not render
* Fix: Builder: Lottie: Progress Animation does not work on Firefox
* Fix: Builder: Backend: make module panel default state as hidden
